...
_SUPPORTED_OPS: typing.Dict[str, typing.Callable] = {
    ...
    "aten::mul_": partial(basic_binary_op_flop_jit, name='aten::mul'),
    ...
    "aten::layer_norm": layernorm_flop_jit,
}
...
def flop_count(
    ...
    for op in total_flop_counter:
        final_count[op] = total_flop_counter[op] / (1024**3)
        final_gflops += final_count[op]
    return "Total Multiply Adds (For Convolution and Linear Layers only): {:,} GFLOPs".format(final_gflops)  # final_count
